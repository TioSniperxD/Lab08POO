...
// Variables para recibir los datos
    ...
    try {
        ...
        if (monto > 0) {
            ...
            if (exito) {
                javax.swing.JOptionPane.showMessageDialog(this, "¡Retiro procesado correctamente!");
                txtMonto.setText("");
                txtIdCuenta.setText("");
                txtIdCliente.setText("");
            } else {
                javax.swing.JOptionPane.showMessageDialog(this, "No se pudo retirar (Verifique Saldo/Cuenta).");
            }
        } else {
